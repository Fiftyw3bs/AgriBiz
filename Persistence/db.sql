...
-- AntiGhostWorker System

CREATE TABLE IF NOT EXISTS Chip (
    chip_id SERIAL NOT NULL,
    chipToken VARCHAR(20) NOT NULL,
    assigned BOOLEAN NOT NULL DEFAULT FALSE,
    PRIMARY KEY(chip_id)
);

insert into chip (chiptoken) values (12324), (123233), (123422), (243112);

CREATE TABLE IF NOT EXISTS User_Chip (
    user_id INT NOT NULL REFERENCES Users(user_id) ON DELETE CASCADE,
    chip_id INT NOT NULL REFERENCES Chip(chip_id) ON DELETE CASCADE,
    PRIMARY KEY(user_id, chip_id)
);

CREATE TABLE IF NOT EXISTS Stamp (
    stamp_id SERIAL NOT NULL,
    chip_id INT NOT NULL REFERENCES Chip(chip_id) ON DELETE CASCADE,
    stampTime TIMESTAMP WITH TIME ZONE NOT NULL,
    stampType BOOLEAN NOT NULL DEFAULT FALSE,
